...
r;do if(c=s.exec(b),!c[4]&&!c[5]&&!c[7]&&!c[1]&&h.error(b.substring(r)),","===c[10])break;while(s.lastIndex<o);r=s.lastIndex;j=c[10]}if(","===j&&(a[1]=!0,n))break;t=j}while(r<o)}return a},querySelectorAll:function(b,d,a,n){a=a||[];a.length=a.length||0;d=d&&(d.nodeType?[d]:d)||[x];s.lastIndex=0;var c,m,u,i,l=!0,g="[object Array]"===Object.prototype.toString.apply(a);if(I){var p,o,e,f=/^\s*[>+~]/.test(b);u=[a,0<a.length||1<d.length];for(c=0,m=d.length;c<m;c++)if(i=d[c],9===i.nodeType)try{h.moveElems(i.querySelectorAll(b),
u[0]),l=!1}catch(t){break}else if(1===i.nodeType&&"OBJECT"!==i.nodeName)if(f&&(p=i.parentNode)){e=(o=i.getAttribute("id"))&&o.replace(/'/g,"\\$&")||"__qsaEngine__";!o&&i.setAttribute("id",e);try{h.moveElems(p.querySelectorAll("[id='"+e+"'] "+b),u[0]),l=!1}catch(j){break}!o&&i.removeAttribute("id")}else if(f)break;else try{h.moveElems(i.querySelectorAll(b),u[0]),l=!1}catch(k){break}}l&&(u=h.parser(b,d,[a,0<a.length||1<d.length]));if(u[1]&&1<a.length)if(n){for(c=a.length;c--;)a[c]._hasDuplicate?(H.call(a,
c,1),g||delete a[a.length]):a[c]._hasDuplicate=!0;for(c=a.length;c--;)a[c]._hasDuplicate=null}else if(v=G,Array.prototype.sort.call(a,h.sortElems),v)for(c=1;c<a.length;c++)a[c]===a[c-1]&&(H.call(a,c--,1),g||delete a[a.length]);return a},error:function(b){throw Error("Syntax error: "+b);}};F.qsa=h})(window);
